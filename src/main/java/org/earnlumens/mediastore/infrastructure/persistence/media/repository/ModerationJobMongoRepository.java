...
public interface ModerationJobMongoRepository extends MongoRepository<ModerationJobEntity, String> {

    List<ModerationJobEntity> findByStatusOrderByCreatedAtAsc(String status, Pageable pageable);
    ...
    List<ModerationJobEntity> findStaleJobs(LocalDateTime heartbeatBefore, Pageable pageable);
    ...
    Optional<ModerationJobEntity> findActiveByTenantIdAndEntryId(String tenantId, String entryId);
}
